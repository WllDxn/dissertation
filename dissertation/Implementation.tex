...
A Right shift is thenverse of left shift, it refers to moving each bit of integer digits to the right, using the operator $n << s$ where $n$ is the integer to be shifted and $s$ is the number of digits the integer should be shifted to the right.
\newline
