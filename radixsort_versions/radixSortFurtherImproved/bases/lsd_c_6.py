...
def absolute(num):
    """
    Custom implementation of abs(Num), prevents errors when handling minimum and maximum integers using RPython
...
def int_bytes(i, radix):
    """
    Returns Minimum number of bytes required to identify an integer in a given base

    :param i: Input integer
    :param radix: Radix of integer
    :return: Number of bytes used to identify integer
    """
    return int(floor(log(absolute(i), radix)))+1
